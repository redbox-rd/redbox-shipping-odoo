{
    ...
    'description': """<h2>Redbox Shipping Integration</h2>
    ...
    <p>Our self-deposit service allows merchants to deposit shipments directly into lockers via API integration.</p>
    <p>Customers can receive, return, and track shipments 24/7 with over 2000 RedBox Points available.</p>
